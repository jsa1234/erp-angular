...
export class UserService {
  ...
  updateUserConfigurations(config:SystemFlagConfiguration[]):Observable<SystemFlagConfiguration[] | CommonError>{
    const url = 'User/UpdateUserSystemFlag';
    return this.httpClient.put<SystemFlagConfiguration[]>(url,config) .pipe(catchError(this.commonHttpErrorService.handleError));
  }
}