...
export class SidebarComponent extends BaseComponent implements OnInit {
  ...
  addclass() {
    return this.currentUrl == "accounts"
      ? true
      : this.currentUrl == "journal"
      ? true
      : this.currentUrl == "receipt"
      ? true
      : this.currentUrl == "voucher"
      ? true
      : false;
  }
  ...
  openBusinessNetwork(){
    const bnApiUrl = environment.bnApiUrl;
    window.open(bnApiUrl, '_blank');
  }
}
