...
@Component({
  selector: 'app-bill-wise-sale-return-report-pdf',
  templateUrl: './bill-wise-sale-return-report-pdf.component.html',
  styleUrls: ['./bill-wise-sale-return-report-pdf.component.scss']
})
export class BillWiseSaleReturnReportPdfComponent implements OnInit,OnChanges {


  @Input() billWiseReport:SaleReturnSummaryReport
  @Input() billWiseReportColumns:ColumnDisplaySettings[]
 billWiseReportDetails:SaleReturnSummaryReport
 billWiseReportList:SaleReturnSummaryReportList[]=[]
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes['billWiseReport']) {
      this.billWiseReportList = this.billWiseReport.salesReturnReportlists;
  ...
  printInvoice() {
    let name = 'Bill Wise Sale Return Report'
    let printContents, popupWin;
    printContents = document.getElementById('billWiseSRreport').innerHTML;
