...
@Component({
  selector: 'app-output-monthly-pdf',
  templateUrl: './output-monthly-pdf.component.html',
  styleUrls: ['./output-monthly-pdf.component.scss']
})
export class OutputMonthlyPdfComponent implements OnChanges {
