...
@Component({
  selector: 'app-output-yearly-quarterly-pdf',
  templateUrl: './output-yearly-quarterly-pdf.component.html',
  styleUrls: ['./output-yearly-quarterly-pdf.component.scss']
})
export class OutputYearlyQuarterlyPdfComponent implements OnChanges {
