...
@Component({
  selector: 'app-input-yearly-quarterly-pdf',
  templateUrl: './input-yearly-quarterly-pdf.component.html',
  styleUrls: ['./input-yearly-quarterly-pdf.component.scss']
})
export class InputYearlyQuarterlyPdfComponent implements OnChanges {
