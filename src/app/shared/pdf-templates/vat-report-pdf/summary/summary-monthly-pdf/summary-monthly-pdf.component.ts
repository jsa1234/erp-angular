...
@Component({
  selector: 'app-summary-monthly-pdf',
  templateUrl: './summary-monthly-pdf.component.html',
  styleUrls: ['./summary-monthly-pdf.component.scss']
})
export class SummaryMonthlyPdfComponent implements OnChanges {
