...
export class VoucherPdfComponent implements OnInit,OnChanges {
  @Input() voucherPDF:IVoucher
  voucherDetailList:AccountVoucherDetails[]=[]
  voucher: Voucher;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['voucherPDF']) {
      this.voucherDetailList = this.voucherPDF.accountVoucherDetails;
      this.voucher =new Voucher(this.voucherPDF);
  ...
  printInvoice() {
    ...
    printContents = document.getElementById('voucher').innerHTML;
